  ...
  return (
    <>
      ...
      <div className="order-container">
        <div className="row">
        {
        (!search.name) ? productDetails.map((item) => (
          <ItemCard item={item} totalCost={totalCost} setTotalCost={setTotalCost} />
        )) : <ItemCard item = {search} totalCost={totalCost} setTotalCost={setTotalCost}/>
        }
        </div>
       
        <button class="total"><Link to="/gateway">Total: {totalCost}</Link></button>
      </div>
    </>
  );
};
